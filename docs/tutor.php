...
echo "<td> <table><tr>";
echo "<td width=300px><h2>".$row['FIRSTNAME']." ".$row['LASTNAME']."</h2>Rating: ".$row['RATE']."</td></tr>";
...
<div id="myModal" class="modal hide fade" style="display: block; ">
            ...
            <div class="modal-body">
			<table><tr>
			<td>Tutor:<input style="width:100px" type="text" placeholder="Tutorname" name="tname" value="<?php echo $id?>"readonly="readonly"></td>
			<td> User:<input style="width:150px" type="text" placeholder="Username" name="uname" value="<?php echo $_SESSION["username"]?>" readonly="readonly"></td>
			 </tr>
			 <tr><td>
			 Subject:<select name="spec" style="width:100px">
			 <?php 
			 ...
			 <td>Period: <input type="text" placeholder="tp" name="tptime" style="width:150px"> </tr>
			 <tr><td>Price: <input type="text" placeholder="price" name="price" style="width:100px"></td> 
			 <td>Date: <input type="text" placeholder="date" name="date"style="width:150px"> </td> </tr></table>
...
<?php if ($_SESSION["username"])
echo "<a data-toggle=\"modal\" href=\"#myModal\" class=\"btn btn-primary btn-large\">Make a schedule</a>";
else
echo "<a data-toggle=\"modal\" href=\"#unlogin\" class=\"btn btn-primary btn-large\">Make a schedule</a>";
?>          
</div><!--/span-->
</div><!--/row-->
</div><!--/span-->
